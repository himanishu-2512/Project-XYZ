...
function Profile({ setLoginUser }) {
  ...
  const fetchUser = useCallback(async () => {
    ...
    try {
      ...
      // }
      if (
        userInfo.data.user.follower.some(
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Box
                  sx={{ position: 'relative', width: '400px', height: '365px' }}
                >
                  <Box
                    sx={{
                      width: '250px',
            ...
            >
                      ...
                      >
                        <StyledAutocomplete
                          ...
                          onChange={(event, newValue) => {
                            if (
                              newValue &&
                              updatedUser.skills.indexOf(newValue) === -1
                            )
                          ...
                          options={skills.filter(
                            (skill) => updatedUser.skills?.indexOf(skill) === -1
                          )}
                          renderInput={(params) => (
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                >
                  <Typography>
                    {user.posts?.length + user.questions?.length} Posts
                  </Typography>
                </Box>
                <Box
                  sx={{
                            ...
                            >
                              ...
                              <Box>
                                <Typography
                                  ...
                                  variant="subtitle1"
                                  onClick={() =>
                                    handleClickUsername(follower.username)
                                  }
                                >
                                  {follower.username}
                                </Typography>
                            ...
                            >
                              ...
                              <Box>
                                <Typography
                                  ...
                                  variant="subtitle1"
                                  onClick={() =>
                                    handleClickUsername(following.username)
                                  }
                                >
                                  {following.username}
                                </Typography>
                      ...
                      <Grid container rowSpacing={2} columnSpacing={2}>
                        ...
                        {user.skills.length > 8 && (
                          ...
                          >
                            ...
                            >
                              <Typography sx={{ transition: 'all 0.15s' }}>
