...
const ViewQuestion = () => {
    ...
    const fetchPost = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/question/getquestion/${questionId}`
        )
  ...
  const handleClickPost = (e, id) => {
    ...
    if (title && description) {
      axios
        .post(
          `${BASE_URL}/question/updatequestion/${userId}/${id}`,
          updatedQuestion
        )
        .then((res) => {
        ...
        >
          <CardHeader
            ...
            action={
              <IconButton
                aria-label="settings"
                onClick={(e) => handleAnchor(e, question._id)}
              >
          ...
          >
            ...
            {username && question.userId.username === username && (
              <MenuItem onClick={() => handleDelete(question._id)}>
                Delete
              </MenuItem>
            )}
