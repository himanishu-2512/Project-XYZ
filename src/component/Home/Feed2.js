 ...
 const [save, setSave] = useState(false);
  ...
  return (
    ...
    >  
      ...
      />
      <CardContent sx={{}}>
        <Typography variant="body1" sx={{color:"text.secondary", marginTop:"0px" , textDecoration:"none" , textAlign:'left'}}>
    ...
    height: 'auto'}}
      ...
      >
        <Typography variant="body2"sx={{marginLeft:'2%'}}> 9 likes</Typography>
        <Typography variant="body2"sx={{marginRight:'2%'}}>10 comments</Typography>
      </Box>
      <Divider/>
      <Box
      sx={{
