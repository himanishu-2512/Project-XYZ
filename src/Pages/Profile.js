...
import { Add, CakeRounded, Cancel, Circle, Close, Edit, Mail, Place } from "@mui/icons-material";
...
function Profile({ setLoginUser }) {
	...
	const handleSkills = (newValue) => {
		setUpdatedUser({
			...updatedUser,
			skills: [newValue, ...updatedUser.skills].sort(),
		});
	};
	const handleSkillRemove = (delSkill) => {
		setUpdatedUser({
			...updatedUser,
			skills: updatedUser.skills.filter((skill) => skill !== delSkill),
		});
	};
				...
				>
					...
					{currentUsername === user.username && (
						...
						>
							...
							/>
							Edit {window.screen.width >= 900 ? "Profile" : ""}
						</Button>
					)}
				</Box>

				<Box sx={{ display: "flex", justifyContent: "space-between", paddingX: { xs: 2, md: 0 } }}>
					<Box
						sx={{
		...
		<>
			...
			{user && (
				...
				>
					...
					<BottomNavbar mode={"profile"} open={open} setOpen={setOpen} />
						...
						>
							...
							>
								<Box
									sx={{
										position: "relative",
										width: { xs: "50vw", sm: "40vw", md: "340px", lg: "400px" },
										height: { xs: "50vw", sm: "40vw", md: "315px", lg: "365px" },
									}}
								>
									<Box
										sx={{
											...
											borderRadius: { md: "50px", lg: "70px" },
										}}
									></Box>
									<Box
										sx={{
											width: { md: "230px", lg: "280px" },
											display: { xs: "none", md: "block" },
											aspectRatio: 1,
							...
							{window.screen.width < 900 && userData()}
							{(user.city || user.dob || user.bio) && (
								<Box
									sx={{
										backgroundColor: "rgba(4, 23, 46, 1)",
										borderRadius: { xs: "30px 30px 0px 0px", md: "30px" },
										display: "flex",
										flexDirection: "column",
										gap: 4,
										padding: 4,
									...
									<Box sx={{ display: "flex", flexWrap: "wrap" }}>
										...
										{user.city && (
											<Box sx={{ display: "flex", color: "white" }}>
												...
												/>
												<Typography sx={{ marginLeft: "15px", color: "#cad8e8" }}>{user.city}</Typography>
											</Box>
										)}
									</Box>
								</Box>
						...
						>
							...
							<StyledModal open={editModalOpen} onClose={() => setEditModalOpen(false)}>
								...
								>
									<Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
										...
										<Close sx={{ color: "white", cursor: "pointer" }} onClick={() => setEditModalOpen(false)} />
									</Box>
									<Box
										sx={{
											flexGrow: 1,
							...
							>
								...
								>
									<Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
										...
										<Close sx={{ color: "white", cursor: "pointer" }} onClick={() => setFollowersModalOpen(false)} />
									</Box>
									<Box
										sx={{
											display: "flex",
							...
							>
								...
								>
									<Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
										...
										<Close sx={{ color: "white", cursor: "pointer" }} onClick={() => setFollowingModalOpen(false)} />
									</Box>
									<Box
										sx={{
											display: "flex",
							...
							<Box
								sx={{
									backgroundColor: "rgba(4, 23, 46, 1)",
									flexGrow: 1,
									borderRadius: { xs: "0px 0px 30px 30px", md: "30px" },
									padding: 4,
									display: "flex",
									flexDirection: "column",
										...
										>
											<Grid container rowSpacing={2} columnSpacing={2}>
												{user.skills.map((skill, index) => {
													if (index > 7) return <React.Fragment key={skill}></React.Fragment>;
													return (
								...
								<StyledModal open={skillModalOpen} onClose={() => setSkillModalOpen(false)}>
									...
									>
										<Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
											...
											<Close sx={{ color: "white", cursor: "pointer" }} onClick={() => setSkillModalOpen(false)} />
										</Box>
										<Box
											sx={{
												display: "flex",
